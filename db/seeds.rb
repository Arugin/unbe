...
begin
  ...
  Article.create({title: "Эпизод 1. \"Чудеса\"",
                  tmp_content: "<p>Сегодня были отсняты материалы для эпизода 1. Ребята хорошо потрудились. Съемки заняли четыре часа времени, а бюджет эпизода впервые чуть было не сдвинулся со стандартной отметки в 0 руб. Но ребята справились с этой проблемой, с чем мы их и поздравляем.</p>",
                  cycle: news,
  ...
  Article.create({title: "Эпизод 3 \"Ребятки\"",
                  tmp_content: "<p>Завершен съемочный день третьего эпизода. Материалы готовы к монтажу, эффектам и переозвучке. Скоро на экранах!</p>",
                  cycle: news,
                  article_type: type_news,
                  article_area: area_news,
  ...
  Article.create({title: "Деятельность \"unbe\" приостановлена",
                  tmp_content: "<p>С прискорбием сообщаем, что по не зависящим от нас обстоятельствам, деятельность unbe приостанавливается на неопределенный срок. Будем ждать новостей и <b>надеяться</b>.</p>",
                  cycle: news,
                  article_type: type_news,
                  article_area: area_news,
