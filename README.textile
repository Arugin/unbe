h1. unbe "!https://travis-ci.org/Arugin/unberails.png(Build Status)!":http://travis-ci.org/Arugin/unberails !https://coveralls.io/repos/Arugin/unberails/badge.png(Coverage Status)!:https://coveralls.io/r/Arugin/unberails
